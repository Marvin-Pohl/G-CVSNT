#!/usr/bin/perl
# $Header: /cvsroot-fuse/tortoisecvs/po/Setup/checkconsistency.pl,v 1.2 2004/11/22 21:21:11 bullestock Exp $
# 
# Summary:
...
# Revision 1.2  2004/11/22 21:21:11  bullestock
# Updated from source.
#
...
for $pofile (@pofiles)
{
    ...
    {
	system("./../TortoiseCVS/msgfmt --statistics $pofile");
    }
}
